...
\item Hotfix Server UnitFactory 生成创建一个单位。可以用作例子。unitComponent.AddChildWithId() 调用的是Entity 里最底封装逻辑。
\item 接着找框架里的Fatory, 看能否找出更多的例子来，用作参考
\end{itemize}
