...
namespace ET {
    public abstract class AService: IDisposable {
        ...
        private (object Message, MemoryStream MemoryStream) lastMessageInfo; // 下面2 句话：多想几遍
        ...
        protected MemoryStream GetMemoryStream(object message) {
            ...
            this.lastMessageInfo = (message, stream); // 缓存：上一个发送的消息
            return stream;
        }
        ...
        public abstract void Send(long channelId, long actorId, object message); // 找个实体类，详看这个方法
