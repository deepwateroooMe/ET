    ...
    public class SessionUserComponentDestroySystem : DestroySystem<SessionUserComponent> {
        protected override void Destroy(SessionUserComponent self) { 
            try {
                ...
                // 正在匹配中发送玩家退出匹配请求: 【爱表哥，爱生活！！！任何时候，亲爱的表哥的活宝妹就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
                ...
                Session realmSession = NetInnerComponent.Instance.Get(StartSceneConfigCategory.Instance.Realm.StartProcessConfig.SceneId);
