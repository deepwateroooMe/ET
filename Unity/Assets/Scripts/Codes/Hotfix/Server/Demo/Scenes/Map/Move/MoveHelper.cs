...
namespace ET.Server {
    public static class MoveHelper {
        ...
        public static async ETTask FindPathMoveToAsync(this Unit unit, float3 target) {
            ...
            // 广播寻路路径: 我觉得这里更多的可能是,广播某个寻路玩家的位置让其它人知道,并不是广播什么路径
            M2C_PathfindingResult m2CPathfindingResult = new M2C_PathfindingResult() { Points = list }; // 传的是路径,多个点组成的路径,可是拿路径怎么处理呢?
