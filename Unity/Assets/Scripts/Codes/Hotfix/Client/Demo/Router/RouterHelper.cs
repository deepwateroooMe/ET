...
namespace ET.Client {
    ...
    public static class RouterHelper { // 路由器帮助类：要把这个类的功能，想明白
        ...
        // 【注册router】：创建了一个导路系统？我觉得是在建会话框（可是X 与Y 的会话框？XY）。它是为当前【客户端场景】添加必备路由网络通信功能模块
        // 【重构前】：建一个【客户端】与【网关服】的【会话框】就可以了呀。这里为什么需要借助路由模块呢？【动态路由系统】自动导？
        // 【路由器会话框】：服务于【客户端】。作用，传心跳包，标记【客户端】是否掉线了；传路由器的心跳包，路由器是否掉线了？。。。
