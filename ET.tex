...
\label{sec:org4044cab}
\subsection{SceneChangeHelper: 场景切换协程}
\label{sec:orga274b73}
\begin{minted}[fontsize=\scriptsize,linenos=false]{csharp}
...
\section{UI 上的事件驱动系统：}
\label{sec:org09b9466}
\subsection{EventType}
\label{sec:org763b254}
\begin{minted}[fontsize=\scriptsize,linenos=false]{csharp}
namespace EventType {
...
\label{sec:org2e6c4fe}
\subsection{LoginHelper.cs}
\label{sec:org5fc9355}
\begin{minted}[fontsize=\scriptsize,linenos=false]{csharp}
...
\label{sec:org15a808d}
\subsection{SessionComponent}
\label{sec:org8afe848}
\begin{minted}[fontsize=\scriptsize,linenos=false]{csharp}
[ComponentOf(typeof(Scene))]
...
\label{sec:orgb7901c3}
\subsection{Player: 玩家}
\label{sec:org61361a8}
\begin{minted}[fontsize=\scriptsize,linenos=false]{csharp}
...
\label{sec:org41d8aa9}
\subsection{ResourcesComponent: 同文件有其生成系}
\label{sec:org8b83402}
\begin{minted}[fontsize=\scriptsize,linenos=false]{csharp}
[ComponentOf]
public class ResourcesComponent: Entity, IAwake, IDestroy {
    public static ResourcesComponent Instance { get; set; }
